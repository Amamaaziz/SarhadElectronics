...
exports.memorySubscribers = exports.memoryMessages = exports.memoryOrders = exports.deleteProductInStore = exports.updateProductInStore = exports.createProductInStore = exports.getCategoriesFromStore = exports.getProductByIdFromStore = exports.getProductsFromStore = exports.checkDbConnection = exports.initialCategories = exports.initialProducts = void 0;
...
let memoryProducts = [...exports.initialProducts];
let memoryCategories = [...exports.initialCategories];
let memoryOrders = [];
exports.memoryOrders = memoryOrders;
let memoryMessages = [];
exports.memoryMessages = memoryMessages;
let memorySubscribers = [];
exports.memorySubscribers = memorySubscribers;
...
const getProductsFromStore = async (options) => {
    const isDbLive = await (0, exports.checkDbConnection)();
    if (isDbLive) {
        const where = {};
        if (options.search) {
            where.OR = [
    ...
    if (options.category && options.category !== 'all-items' && options.category !== 'All Items') {
        ...
        filtered = filtered.filter((p) => p.categorySlug === cat || p.categoryName.toLowerCase() === cat);
    }
    if (options.featured !== undefined) {
...
const getProductByIdFromStore = async (id) => {
    const isDbLive = await (0, exports.checkDbConnection)();
    if (isDbLive) {
...
exports.getProductByIdFromStore = getProductByIdFromStore;
const getCategoriesFromStore = async () => {
    const isDbLive = await (0, exports.checkDbConnection)();
    if (isDbLive) {
...
exports.getCategoriesFromStore = getCategoriesFromStore;
const createProductInStore = async (data) => {
    const isDbLive = await (0, exports.checkDbConnection)();
    if (isDbLive) {
...
exports.createProductInStore = createProductInStore;
const updateProductInStore = async (id, data) => {
    const isDbLive = await (0, exports.checkDbConnection)();
    if (isDbLive) {
...
const deleteProductInStore = async (id) => {
    const isDbLive = await (0, exports.checkDbConnection)();
    if (isDbLive) {
...
exports.deleteProductInStore = deleteProductInStore;
